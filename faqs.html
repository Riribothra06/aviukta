...
<!-- Mirrored from html.awaikenthemes.com/artistic/faqs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jun 2025 03:55:49 GMT -->
<head>
	<!-- Meta -->
	<meta charset="utf-8">
                    ...
                    <div class="page-faqs-catagery">
                        ...
                        <div class="our-faq-section page-faq-accordion" id="general_information">
                            <div class="section-title">
                                <h2 class="text-anime-style-3">General <span>information</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                        ...
                        <div class="our-faq-section page-faq-accordion" id="content_creation_FAQ">
                            <div class="section-title">
                                <h2 class="text-anime-style-3">Content <span>creation</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                        ...
                        <div class="our-faq-section page-faq-accordion" id="project_management_FAQ">
                            <div class="section-title">
                                <h2 class="text-anime-style-3">Project <span>management</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                        ...
                        <div class="our-faq-section page-faq-accordion" id="pricing_payments_FAQ">
                            <div class="section-title">
                                <h2 class="text-anime-style-3">Pricing & <span>payments</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                    ...
                    <div class="faq-sidebar">
                        ...
                        <div class="sidebar-cta-box wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="cta-contact-btn">
                                <a href="tel:3098855314"><img src="images/icon-sidebar-cta-phone.svg" alt=""> (30) 8855-314</a>
                            </div>
